  ...
  <section style="margin-top: 20px">
    ...
    <el-table :data="city" style="width: 100%" :row-key="getRowKey" :expand-row-keys="expand">
      <el-table-column type="expand">
        <template slot-scope="props">
          <el-table :data="props.row.cityMenus" :row-key="getRowKeys" :expand-row-keys="expands" style="width: 100%">
            <el-table-column type="expand">
              <template slot-scope="prop">
                <el-table :data="foods" style="width: 100%">
                  ...
                  <el-table-column label="操作" width="250">
                    <template slot-scope="props">
                      <el-button type="warning" size="mini" @click="handleEdit(props.$index, props.row)">修改</el-button>
                      <el-button type="danger" size="mini" @click="delFoods(props.row.foodsId, props.row.citymenuId)">删除
                      </el-button>
                    </template>
                  </el-table-column>
                </el-table>
            ...
            <el-table-column label="操作" width="300">
              <template slot-scope="props">
                ...
                <el-button type="primary" size="mini" @click="handleAdd(props.$index, props.row)">发布</el-button>
              </template>
            </el-table-column>
          </el-table>
        </template>
      ...
      <el-table-column label="操作" width="250">
        <template slot-scope="props">
          ...
          <el-button type="primary" size="mini" @click="handleAddCity(props.$index, props.row)">发布</el-button>
        </template>
      </el-table-column>
    </el-table>
        ...
        <el-form-item>
          ...
          <div class="img_box" v-for="(item, index) in imgArr" :key="index">
            <div class="img_show_box">
              ...
              <button type="button" style="float:left;background: #fff;border: none;" @click="deleteImg(index)"
                aria-label="Close">
    ...
    <el-dialog title="新增" :visible.sync="addCityFormVisible" :close-on-click-modal="false">
      <el-form :model="addCityForm" ref="addForm">
        ...
        <el-form-item label="名称">
          <el-input type="textarea" v-model="addCityForm.citymenuIntro" auto-complete="off" :rows="2"
            placeholder="请输入内容">
          </el-input>
        </el-form-item>
        <el-form-item>
